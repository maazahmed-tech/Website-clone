...
const industries = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0A1.5 1.5 0 003 15.546m18-6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 9.546m18 0v6m-18-6v6" />
      </svg>
    ),
  },
  {
      ...
      <section className="bg-[#0B0C0D] pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Industries We <span className="text-[#2ED06E]">Serve</span>
          </h1>
          <p className="text-lg text-gray-300 max-w-2xl">
            We deliver tailored technology solutions across diverse industries,
            combining deep domain expertise with cutting-edge innovation.
          </p>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {industries.map((industry) => (
              <Link
                ...
                className="group bg-white rounded-xl p-6 border border-gray-200 hover:border-[#2ED06E] hover:shadow-lg transition-all duration-300"
              >
                <div className="w-14 h-14 bg-[#2ED06E]/10 rounded-xl flex items-center justify-center text-[#2ED06E] mb-4 group-hover:bg-[#2ED06E] group-hover:text-white transition-colors">
                  {industry.icon}
                </div>
