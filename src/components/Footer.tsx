            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item.href}>
                    <Link href={item.href} className="text-sm text-gray-500 hover:text-[#1E6FD9] transition-colors">
                      {item.label}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="flex items-center gap-2 text-sm text-gray-400 hover:text-[#1E6FD9] transition-colors"
                >
                  <svg
            ...
            <div className="flex flex-col items-end gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  aria-label="LinkedIn"
                  className="w-9 h-9 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-[#1E6FD9] hover:bg-[#1E6FD9]/10 transition-all duration-300"
                >
