...
const services: ServicePageData[] = [
  {
    ...
    metaTitle: 'Mobile App Development Services | Cubix',
    metaDescription: 'Cubix delivers custom mobile app development services for iOS and Android. Build scalable, user-friendly mobile applications with our expert team.',
    ...
    overviewDescription: 'Cubix is a leading mobile app development company with a track record of building successful apps across industries. Our team of skilled developers, designers, and strategists work together to create mobile experiences that stand out in competitive app stores.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaDescription: 'Cubix provides custom software development services tailored to your business needs. Build scalable, secure enterprise software solutions.',
    ...
    overviewDescription: 'Cubix specializes in building bespoke software solutions that solve complex business challenges. Our experienced team follows agile methodologies to deliver reliable, maintainable software on time and within budget.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Web Application Development Services | Cubix',
    metaDescription: 'Cubix builds scalable, responsive web applications using modern frameworks. Custom web app development for startups and enterprises.',
    ...
    overviewDescription: 'Cubix delivers full-stack web application development using modern frameworks and best practices. We build web apps that are fast, secure, and scalable to meet the demands of growing businesses.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Game Development Services | Cubix',
    metaDescription: 'Cubix offers end-to-end game development services across mobile, PC, and console platforms. Build immersive gaming experiences with our expert team.',
    ...
    overviewDescription: 'Cubix is a full-service game development company with expertise across all major platforms and game engines. Our designers, developers, and artists collaborate to create games that captivate audiences and generate revenue.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Blockchain Development Services | Cubix',
    metaDescription: 'Cubix provides blockchain development services including smart contracts, DApps, DeFi platforms, and token development. Build decentralized solutions.',
    ...
    overviewDescription: 'Cubix is a trusted blockchain development company that helps businesses leverage distributed ledger technology. We build custom blockchain solutions across Ethereum, Solana, Polygon, and other leading chains.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'AI Development Services | Cubix',
    metaDescription: 'Cubix delivers AI development services including machine learning, NLP, computer vision, and predictive analytics. Transform your business with intelligent solutions.',
    ...
    overviewDescription: 'Cubix helps businesses unlock the potential of artificial intelligence with custom AI solutions. Our data scientists and ML engineers build models that solve real business problems and deliver measurable ROI.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Cloud Software Development Services | Cubix',
    metaDescription: 'Cubix delivers cloud software development services including cloud migration, cloud-native apps, and managed cloud infrastructure on AWS, Azure, and GCP.',
    ...
    overviewDescription: 'Cubix helps businesses harness the full potential of cloud computing. From cloud migration and infrastructure setup to building cloud-native applications, we deliver solutions that scale with your business.',
    overviewPoints: [
      'Cloud-native application development',
  ...
  },
  {
    ...
    metaTitle: 'eCommerce App Development Services | Cubix',
    metaDescription: 'Cubix builds custom eCommerce mobile apps and platforms that drive sales, engage customers, and streamline online retail operations.',
    ...
    overviewDescription: 'Cubix creates custom eCommerce solutions that help businesses sell more effectively online. From mobile shopping apps to full-featured marketplace platforms, we build commerce experiences that convert browsers into buyers.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Cross-Platform App Development Services | Cubix',
    metaDescription: 'Cubix builds cross-platform mobile apps using React Native and Flutter. One codebase, multiple platforms, reduced cost.',
    ...
    overviewDescription: 'Cubix delivers high-quality cross-platform apps using React Native and Flutter. Our approach lets you reach iOS and Android users simultaneously while maintaining a native-like experience on both platforms.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Flutter App Development Services | Cubix',
    metaDescription: 'Cubix offers Flutter app development services to build beautiful, natively compiled apps for mobile, web, and desktop from a single codebase.',
    ...
    overviewDescription: 'Cubix leverages Flutter to build visually stunning, fast applications that run on multiple platforms. Our Flutter developers create pixel-perfect UIs with smooth animations and excellent performance.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'React Native App Development Services | Cubix',
    metaDescription: 'Cubix builds high-performance React Native apps for iOS and Android. Leverage JavaScript expertise to build cross-platform mobile applications.',
    ...
    overviewDescription: 'Cubix builds cross-platform mobile apps with React Native that feel truly native. Our React Native experts create performant apps that share code across iOS and Android while accessing native device capabilities.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Ionic App Development Services | Cubix',
    metaDescription: 'Cubix develops hybrid mobile apps with Ionic framework. Build cross-platform apps using web technologies like HTML, CSS, and JavaScript.',
    ...
    overviewDescription: 'Cubix uses the Ionic framework to build hybrid mobile applications that combine the flexibility of web development with native device capabilities through Capacitor and Cordova plugins.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'VisionOS App Development Services | Cubix',
    metaDescription: 'Cubix develops immersive apps for Apple Vision Pro using VisionOS. Build spatial computing experiences with our expert developers.',
    ...
    overviewDescription: 'Cubix is at the forefront of spatial computing development with VisionOS. Our team builds immersive experiences for Apple Vision Pro that leverage spatial interactions, 3D content, and mixed reality.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Enterprise App Development Services | Cubix',
    metaDescription: 'Cubix develops enterprise-grade mobile and web applications that streamline operations, improve productivity, and drive digital transformation.',
    ...
    overviewDescription: 'Cubix delivers enterprise software solutions that transform how organizations operate. We build secure, compliant applications that integrate with existing systems and scale to support thousands of users.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'iPhone App Development Services | Cubix',
    metaDescription: 'Cubix develops custom iPhone apps using Swift and SwiftUI. Build high-quality iOS applications that deliver exceptional Apple ecosystem experiences.',
    ...
    overviewDescription: 'Cubix creates world-class iPhone apps that leverage the latest iOS features and Apple technologies. Our iOS developers build apps that feel native, perform beautifully, and integrate seamlessly with the Apple ecosystem.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Android App Development Services | Cubix',
    metaDescription: 'Cubix builds custom Android apps using Kotlin and Jetpack Compose. Reach billions of Android users with high-quality mobile applications.',
    ...
    overviewDescription: 'Cubix develops high-quality Android apps that perform consistently across the diverse Android ecosystem. Our developers use Kotlin, Jetpack libraries, and Material Design to create apps that users love.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Augmented Reality Development Services | Cubix',
    metaDescription: 'Cubix develops AR applications for mobile, wearables, and enterprise. Build immersive augmented reality experiences that transform how users interact with the world.',
    ...
    overviewDescription: 'Cubix develops AR solutions using ARKit, ARCore, and WebAR technologies. Our team creates immersive augmented reality experiences for mobile devices, smart glasses, and enterprise applications.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Virtual Reality Development Services | Cubix',
    metaDescription: 'Cubix develops immersive VR applications for training, gaming, education, and enterprise. Build virtual reality experiences that engage and transform.',
    ...
    overviewDescription: 'Cubix builds VR applications for Meta Quest, HTC Vive, PlayStation VR, and other leading platforms. Our VR team creates immersive experiences that range from interactive training simulations to engaging VR games.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Metaverse Development Services | Cubix',
    metaDescription: 'Cubix builds metaverse applications and virtual worlds. Create immersive digital experiences with avatars, social interaction, and virtual economies.',
    ...
    overviewDescription: 'Cubix designs and develops metaverse platforms that combine VR, AR, blockchain, and social interaction. We create persistent virtual worlds where users can socialize, work, play, and transact.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'IoT App Development Services | Cubix',
    metaDescription: 'Cubix builds IoT applications that connect devices, collect data, and enable smart automation. Custom IoT solutions for industry and consumer markets.',
    ...
    overviewDescription: 'Cubix develops end-to-end IoT solutions including device firmware, cloud platforms, mobile apps, and analytics dashboards. We help businesses harness the power of connected devices for automation and insight.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Software Consulting Services | Cubix',
    metaDescription: 'Cubix provides expert software consulting services to help businesses define technology strategies, architect solutions, and optimize development processes.',
    ...
    overviewDescription: 'Cubix offers strategic software consulting that bridges the gap between business objectives and technology solutions. Our consultants bring deep industry knowledge and technical expertise to guide your digital initiatives.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Software Testing Services | Cubix',
    metaDescription: 'Cubix offers comprehensive software testing services including functional, performance, security, and automation testing to ensure quality.',
    ...
    overviewDescription: 'Cubix delivers end-to-end testing services that cover every aspect of software quality. Our QA engineers use both manual and automated testing approaches to identify defects early and ensure top-quality releases.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Custom API Development Services | Cubix',
    metaDescription: 'Cubix builds custom APIs and integration solutions. RESTful APIs, GraphQL endpoints, and third-party integrations for seamless data connectivity.',
    ...
    overviewDescription: 'Cubix builds robust APIs that serve as the backbone of modern applications. Our API development services include RESTful APIs, GraphQL endpoints, webhook systems, and third-party integration solutions.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Web Development Services | Cubix',
    metaDescription: 'Cubix provides full-stack web development services. Build responsive, fast, and secure websites and web applications with modern technologies.',
    ...
    overviewDescription: 'Cubix delivers comprehensive web development services covering frontend, backend, and full-stack solutions. We build websites and web apps that are fast, secure, accessible, and optimized for search engines.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Custom Web Development Services | Cubix',
    metaDescription: 'Cubix builds custom websites and web solutions tailored to your unique business requirements. Bespoke web development from concept to launch.',
    ...
    overviewDescription: 'Cubix creates fully custom web solutions that go beyond template-based approaches. Every website we build is designed and coded from scratch to match your exact specifications, branding, and functionality needs.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Custom eCommerce Development Company | Cubix',
    metaDescription: 'Cubix is a custom eCommerce development company. We build tailored online stores and marketplace platforms that drive sales and growth.',
    ...
    overviewDescription: 'Cubix creates bespoke eCommerce solutions for businesses that have outgrown template-based platforms. We build custom online stores, marketplaces, and B2B portals that handle complex product catalogs, pricing, and fulfillment workflows.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Magento Development Services | Cubix',
    metaDescription: 'Cubix provides Magento development services including custom themes, extensions, and migrations. Build powerful eCommerce stores with Adobe Commerce.',
    ...
    overviewDescription: 'Cubix specializes in Magento and Adobe Commerce development for businesses that need a powerful, flexible eCommerce platform. We build custom themes, extensions, and complete Magento stores optimized for performance and conversions.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'WooCommerce Development Services | Cubix',
    metaDescription: 'Cubix offers WooCommerce development services. Build and customize WordPress-powered online stores with plugins, themes, and integrations.',
    ...
    overviewDescription: 'Cubix creates high-performing WooCommerce stores built on WordPress. We develop custom themes, build plugins, and optimize performance to help businesses sell effectively online with complete control over their store.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Shopify Website Development Services | Cubix',
    metaDescription: 'Cubix provides Shopify development services including custom themes, app development, and Shopify Plus solutions for growing eCommerce brands.',
    ...
    overviewDescription: 'Cubix is a Shopify development partner that helps brands create outstanding online stores. We build custom Shopify themes, develop apps, and optimize stores for conversion and performance on both Shopify and Shopify Plus.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Smart Contract Development Services | Cubix',
    metaDescription: 'Cubix develops secure, audited smart contracts for DeFi, NFTs, DAOs, and token systems on Ethereum, Solana, and other blockchain networks.',
    ...
    overviewDescription: 'Cubix builds smart contracts that are secure, gas-optimized, and rigorously tested. Our blockchain engineers develop contracts for Ethereum, Solana, Polygon, and other networks with comprehensive security auditing.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'NFT Development Services | Cubix',
    metaDescription: 'Cubix builds NFT platforms, marketplaces, and minting solutions. Create, sell, and trade NFTs with custom blockchain-powered applications.',
    ...
    overviewDescription: 'Cubix develops complete NFT solutions from smart contracts to frontend experiences. We help creators, brands, and businesses launch NFT collections, build marketplaces, and integrate NFTs into existing products.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Web3 Development Services | Cubix',
    metaDescription: 'Cubix provides Web3 development services including DApps, DeFi, DAOs, and decentralized identity solutions. Build the decentralized web with our expertise.',
    ...
    overviewDescription: 'Cubix develops Web3 solutions that reimagine how applications work by putting users in control of their data and assets. We build DApps, DeFi platforms, and decentralized identity systems using cutting-edge Web3 technologies.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'DApp Development Services | Cubix',
    metaDescription: 'Cubix develops decentralized applications (DApps) on Ethereum, Solana, and other blockchains. Build secure, transparent DApps with smart contract backends.',
    ...
    overviewDescription: 'Cubix creates full-stack decentralized applications that leverage blockchain for trustless operations. We handle everything from smart contract development to web3 frontend integration and deployment.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Product Design Services | Cubix',
    metaDescription: 'Cubix offers end-to-end product design services including research, wireframing, prototyping, and visual design. Create products users love.',
    ...
    overviewDescription: 'Cubix product design team combines user research, interaction design, and visual design to create digital products that solve real problems. We design products that are both beautiful and functional.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'MVP Software Development Services | Cubix',
    metaDescription: 'Cubix builds MVPs that validate your idea fast. Rapid MVP development with lean approach to test markets and attract investors.',
    ...
    overviewDescription: 'Cubix helps startups launch faster with lean MVP development. We focus on core features that validate your business hypothesis, enabling you to iterate based on real user feedback before committing to full-scale development.',
    overviewPoints: [
  ...
  },
  {
    ...
    title: 'UX Design',
    metaTitle: 'UX Design Services | Cubix',
    metaDescription: 'Cubix offers UX design services including user research, wireframing, prototyping, and usability testing. Create intuitive user experiences.',
    ...
    overviewDescription: 'Cubix UX design services focus on understanding user needs and behaviors to create products that are easy to use and enjoyable. We combine qualitative research with data analysis to make informed design decisions.',
    overviewPoints: [
  ...
  },
  {
    ...
    title: 'UI Design',
    metaTitle: 'UI Design Services | Cubix',
    metaDescription: 'Cubix provides UI design services that create beautiful, consistent, and brand-aligned interfaces. Pixel-perfect designs and design systems.',
    ...
    overviewDescription: 'Cubix UI design team creates beautiful, functional interfaces that express your brand identity while ensuring excellent usability. We build comprehensive design systems that maintain consistency across all touchpoints.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'AWS Development Services | Cubix',
    metaDescription: 'Cubix provides AWS development services including cloud architecture, migration, serverless development, and managed AWS infrastructure.',
    ...
    overviewDescription: 'Cubix is an experienced AWS partner that helps businesses leverage the full breadth of Amazon Web Services. We design architectures, build applications, and manage infrastructure on AWS for optimal performance and cost.',
    overviewPoints: [
  ...
  },
  {
    ...
    title: 'DevOps',
    metaTitle: 'DevOps Software Development Services | Cubix',
    metaDescription: 'Cubix provides DevOps services including CI/CD pipelines, infrastructure automation, containerization, and monitoring for faster, reliable software delivery.',
    ...
    overviewDescription: 'Cubix helps teams adopt DevOps culture and tooling for faster, more reliable software delivery. We implement automation, monitoring, and collaboration practices that bridge development and operations.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Unity Game Development Services | Cubix',
    metaDescription: 'Cubix develops games with Unity engine for mobile, PC, console, and VR/AR. Build cross-platform games with high-quality graphics and engaging gameplay.',
    ...
    overviewDescription: 'Cubix Unity development team creates games across all genres and platforms. Unity versatility allows us to build mobile games, console titles, VR experiences, and AR applications with a single powerful engine.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Unreal Engine Game Development Services | Cubix',
    metaDescription: 'Cubix develops high-fidelity games with Unreal Engine. Build AAA-quality gaming experiences for PC, console, and VR with cutting-edge graphics.',
    ...
    overviewDescription: 'Cubix Unreal Engine team builds games and interactive experiences that demand the highest visual quality. Unreal Engine advanced rendering, physics, and tooling enable us to create AAA-quality experiences.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Blockchain Game Development Services | Cubix',
    metaDescription: 'Cubix develops blockchain-based games with play-to-earn mechanics, NFT integration, and token economies. Build the next generation of gaming.',
    ...
    overviewDescription: 'Cubix combines game development expertise with blockchain technology to create games where players own their assets, earn rewards, and participate in decentralized game economies.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Mobile Game Development Services | Cubix',
    metaDescription: 'Cubix develops mobile games for iOS and Android. From casual to mid-core games, we create engaging mobile gaming experiences that retain and monetize.',
    ...
    overviewDescription: 'Cubix develops mobile games across all genres using Unity and native technologies. We focus on creating games with compelling mechanics, stunning visuals, and proven monetization strategies.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: '2D Game Development Services | Cubix',
    metaDescription: 'Cubix develops 2D games for mobile, PC, and web platforms. From platformers to puzzle games, we create engaging 2D gaming experiences.',
    ...
    overviewDescription: 'Cubix develops polished 2D games across all genres and platforms. Our artists and developers create games with hand-crafted art, fluid animation, and gameplay mechanics that keep players coming back.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: '3D Game Development Services | Cubix',
    metaDescription: 'Cubix develops 3D games for mobile, PC, console, and VR platforms. Build immersive 3D gaming experiences with stunning graphics and gameplay.',
    ...
    overviewDescription: 'Cubix 3D game development team creates visually impressive games across all platforms. Our 3D artists, animators, and programmers collaborate to build games with photorealistic environments, complex AI, and smooth performance.',
    overviewPoints: [
  ...
  },
  {
    ...
    metaTitle: 'Multiplayer Game Development Services | Cubix',
    metaDescription: 'Cubix develops multiplayer games with real-time networking, matchmaking, and social features. Build competitive and cooperative gaming experiences.',
    ...
    overviewDescription: 'Cubix develops multiplayer gaming experiences across all genres and platforms. Our networking engineers and game developers build robust real-time multiplayer systems that handle thousands of concurrent players.',
    overviewPoints: [
