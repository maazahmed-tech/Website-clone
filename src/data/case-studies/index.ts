...
export const caseStudies: CaseStudyPageData[] = [
  {
    ...
    metaTitle: 'Pauseitive Case Study | Mental Health App by DeepLearnHQ',
    metaDescription: 'How DeepLearnHQ built Pauseitive, a mental wellness app with guided meditation, mood tracking, and therapy resources that reached 500K+ downloads.',
    heroImage: '/case-studies/pauseitive-hero.jpg',
    category: 'Healthcare & Wellness',
    overview: 'Pauseitive is a mental wellness mobile application designed to help users manage stress, anxiety, and emotional well-being through guided meditation, mood tracking, and personalized therapy resources. DeepLearnHQ partnered with the Pauseitive team to design, develop, and launch the platform across iOS and Android.',
    ...
    solution: 'DeepLearnHQ designed a calming, accessibility-first user interface validated through user research with licensed therapists. We built an adaptive recommendation engine that personalizes meditation and therapy content based on mood journal entries and usage patterns. The back end leverages AWS with HIPAA-compliant storage, and audio content is delivered through a global CDN with offline caching for uninterrupted access. Push notification schedules are tailored to each user\'s preferred wellness routine.',
    results: [
    ...
    testimonial: {
      quote: 'DeepLearnHQ didn\'t just build an app—they helped us create a movement. Their technical expertise and genuine care for our mission made all the difference.',
  ...
  },
  {
    ...
    metaDescription: 'Discover how DeepLearnHQ built PartyShark, an event management app that simplifies party planning with invitations, RSVPs, and vendor coordination.',
    heroImage: '/case-studies/partyshark-hero.jpg',
    category: 'Events & Entertainment',
    overview: 'PartyShark is an event management application that simplifies party planning by combining digital invitations, RSVP tracking, vendor coordination, and budget management into one seamless mobile experience. DeepLearnHQ handled full-cycle product development from ideation through App Store launch.',
  ...
  },
  {
    ...
    metaTitle: 'Oomco Case Study | On-Demand Fuel Delivery App by DeepLearnHQ',
    metaDescription: 'Learn how DeepLearnHQ developed Oomco\'s on-demand fuel delivery app with real-time tracking, fleet management, and a seamless customer experience.',
    heroImage: '/case-studies/oomco-hero.jpg',
    category: 'Logistics & Transportation',
    overview: 'Oomco is a pioneering on-demand fuel delivery platform operating in the Middle East. DeepLearnHQ developed a comprehensive three-app ecosystem—a customer app, a driver app, and an operations dashboard—that enables consumers to order fuel delivered directly to their vehicle\'s location.',
  ...
  },
  {
    ...
    metaDescription: 'How DeepLearnHQ built Foodly, a food ordering and delivery platform with AI-powered recommendations, real-time tracking, and restaurant management tools.',
    heroImage: '/case-studies/foodly-hero.jpg',
    category: 'Food & Beverage',
    overview: 'Foodly is a food ordering and delivery platform that connects diners with local restaurants through a polished mobile experience. DeepLearnHQ developed the full technology stack including the consumer app, restaurant dashboard, rider app, and administrative back end.',
    ...
    solution: 'DeepLearnHQ engineered a microservices architecture that handles thousands of concurrent orders with sub-second response times. The consumer app features an AI recommendation engine that learns individual taste preferences and dietary restrictions. We built a restaurant management dashboard with real-time order tracking, menu management, revenue analytics, and peak-hour staffing suggestions. The rider app uses a proprietary batching algorithm that groups nearby deliveries to reduce wait times and increase rider earnings.',
    results: [
    ...
    testimonial: {
      quote: 'DeepLearnHQ gave us the technical edge we needed to compete with the big players. Their architecture handles our growth without breaking a sweat, and the analytics they built for our restaurant partners are a genuine competitive advantage.',
      name: 'Priya Sharma',
  ...
  },
  {
    ...
    overview: 'Forest Fusion is an IoT-powered environmental monitoring platform that combines satellite imagery, ground-based sensor networks, and citizen science data to track deforestation, air quality, and biodiversity across protected ecosystems. DeepLearnHQ developed the full technology platform including the data ingestion pipeline, analytics engine, and public-facing dashboard.',
    ...
    solution: 'DeepLearnHQ designed a cloud-native data pipeline using AWS Lambda and Kinesis for real-time stream processing of IoT sensor data. Satellite imagery from Sentinel-2 and Landsat is processed through custom computer vision models that detect vegetation change at 10-meter resolution. A geospatial analytics engine correlates multiple data sources to generate comprehensive ecosystem health scores. The public dashboard uses Mapbox GL for interactive map visualizations, while a mobile app enables field researchers to submit geotagged observations and photographs.',
    results: [
    ...
    testimonial: {
      quote: 'DeepLearnHQ turned our vision of a connected forest into reality. Their engineering team tackled the hardest geospatial and IoT challenges we threw at them, and the platform is now our most powerful tool for conservation advocacy.',
